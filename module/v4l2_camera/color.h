 ...
 * Brief: Adjust some layout and style of origin program
 */ 

typedef struct _MyRGB16
{
...
#define UNPACKRGB16(pixel,r,g,b) r=((pixel)&0xf800) >> 8; 	g=((pixel)&0x07e0) >> 3; b=(((pixel)&0x001f) << 3)
